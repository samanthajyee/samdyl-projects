...
**Samantha**: repo structure, backend schema, project board  
**Dylan**: UI prototype (Figma), database diagram  
...
- 🔄 Sync Dylan’s VSCode & repo access: In progress  
- 🧪 Run ALGO training loop via Live Share & review first full report  
- ✅ Add Figma prototype link to ALGO repo  
- ⏳ Add Figma prototype link to BASEBALL repo: Coming soon  
- 💻 Draft schema for BASEBALL backend  
- 🧠 Sketch BRAINBARR’s gameplay loop (lightweight wire, no dev yet) 
